    ...
    >
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={8} display="flex" flexDirection="column" justifyContent="center">
          ...
          <a href={upi.intent}>
            <Button style={{ textDecoration: 'none', marginBottom: '10px', marginTop: '10px' }} variant="contained">Pay </Button>
          </a>
        </Grid>
      </Grid>
    </Box>
